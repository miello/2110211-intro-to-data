...
namespace CP
{
    ...
    public:
        ...
        {
            iterator target = mHeader->next;
            iterator iter = mHeader->next;
            while (pos--)
            {
                target++;
            }
            ...
            while(idx < selected.size()) {
                if(selected[idx] == cnt) {
                    ...
                    target.ptr->prev->next = tmp.ptr;
                    tmp.ptr->prev = target.ptr->prev;
                    tmp.ptr->next = target.ptr;
                    target.ptr->prev = tmp.ptr;
                } else {
                    iter++;
                }
                cnt++;
